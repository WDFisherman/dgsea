...
class TwoByTwoContingencyTableTest {
    ...
    /**
     * Tests that a NullPointerException is thrown when there is a
     * complete lack of Pathway1 in pathwayGenes.
     */
    @Test
    ...
    /**
     * Tests the contingency table when DEGs have missing genes in pathways.
     */
    @Test
